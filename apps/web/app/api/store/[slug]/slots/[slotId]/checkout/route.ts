...
export async function POST(request: Request, { params }: { params: { slug: string; slotId: string } }): Promise<Response> {
  try {
    ...
    console.error("[API /api/store/[slug]/slots/[slotId]/checkout]", error);
