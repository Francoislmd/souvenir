    ...
    <div className={`relative ${className}`} style={{ width: 218, height: 447 }}>
      ...
      <div className="absolute inset-[3px] overflow-hidden rounded-[35px] bg-[#FAF7F4]">
        ...
        <div className="mx-2.5 mt-2">
          {unlocked ? (
            <div className="flex items-center gap-1.5 rounded-full px-3 py-2" style={{ background: "#EAF7EE" }}>
              <svg viewBox="0 0 12 12" fill="none" className="h-3 w-3 shrink-0">
                <path d="M2 6l2.5 2.5L10 4" stroke="#16A34A" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <span className="flex-1 text-[10px] font-bold" style={{ color: "#16A34A" }}>Photos débloquées !</span>
              <span className="text-[9px] font-medium" style={{ color: "#16A34A", opacity: 0.65 }}>Télécharger</span>
            </div>
          ) : (
            <div
